...
dates <- data.frame(year=1973:1982,date=c("1973-04-01", "1974-03-31", "1975-04-06", "1976-04-04", "1977-04-03", "1978-04-02", "1979-04-01", "1980-03-30", "1981-04-05", "1982-04-04"))
```
...
```{r}
##temp <- left_join(CBdata.1_10, dates, by = "Year")
##str(CBdata.1_10)
