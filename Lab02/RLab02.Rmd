...
IPS_sampledata <- IPS_sampledata %>%
  mutate(rec_orient = case_when(
    orientation >= 337.5 | orientation < 22.5 ~ 0,
    orientation >= 22.5 & orientation < 67.5 ~ 45,
    orientation >= 67.5 & orientation < 112.5 ~ 90,
    orientation >= 112.5 & orientation < 157.5 ~ 135,
    orientation >= 157.5 & orientation < 202.5 ~ 180,
    orientation >= 202.5 & orientation < 247.5 ~ 225,
    orientation >= 247.5 & orientation < 292.5 ~ 270,
    orientation >= 292.5 & orientation < 337.5 ~ 315
  ))
```
...
signal_summary <- IPS_sampledata %>%
  group_by(posX, posY, posZ, rec_orient, mac) %>%
  summarise(
