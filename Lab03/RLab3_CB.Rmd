...
```{r}
<<<<<<< HEAD
# convert race time to seconds and then to minutes for easier interpretation
CBdata.Clean$Time_seconds <- period_to_seconds(hms(CBdata.Clean$Time))
CBdata.Clean$Time_minutes <- CBdata.Clean$Time_seconds / 60
```

```{r}
# create a scatter plot of Age vs. Time in minutes
=======

>>>>>>> 919c846ef28de4b801f6ed58587ba2f5cfb83686
